...
const deriveTrifleTokens = async (connection, nftPublicKey, trifleAuthority) => {
    const [trifleAddress] = findTriflePda(nftPublicKey, trifleAuthority);
    return getTrifleTokens(connection, trifleAddress);
}
